...
// ! Da calibrare per il singolo sensore, guardare una guida su come fare (la calibrazione andrebbe fatta ad un metro di distnaza)
// ! Ovviamente le board che usiamo sono merdose, no shielding e no rf matching (catena di induttori e condensatori) quindi non avremo risultati solidi...
// ! Nell'AI deck invece c'è un RF matching fatto bene, e un bellissimo shield per le interferenze...
...
{
    // Se non abbiamo almeno 5 misurazioni o è passato troppo tempo, fuori portata
